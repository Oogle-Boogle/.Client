...
public class Splash extends JFrame {
	...
	private static String downloadUrl = "https://www.dropbox.com/s/rpgkn2bxghjtx1a/Empire.jar?dl=1"; 
	private static String fileName = "Empire.jar"; 
	private static String serverName = "Empire"; 
	private static String backgroundImageUrl = "https://www.dropbox.com/s/vo6hvlzjt30yloc/EmpireLauncherLogo.png?dl=1"; 
    ...
    public Splash() {
        ...
        imglabel.setBounds(0, 0, 700, 380);
        add(pbar);
