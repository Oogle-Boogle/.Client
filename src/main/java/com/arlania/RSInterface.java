...
import static com.arlania.RSInterface.addContainer;
import static com.arlania.RSInterface.addInterface;
import static com.arlania.RSInterface.addRectangle;
import static com.arlania.RSInterface.addText;
import static com.arlania.RSInterface.fonts;
import static com.arlania.RSInterface.interfaceCache;
...
//47502
	...
	public static void EquipmentTab(TextDrawingArea[] tda) {
		...
		addToItemGroup(49374, 2, 1, 49, 10, true, "Operate", "Remove", null,true);
...
//are you even using this interface?
	...
	private static void bankInterface() {
		...
		addBankHover(78395, 4, 78396, 1020, 1021, "", 35, 25, 111, 1, "Toggle placeholders", 78397, 14, 16, "", 78398,
				"Toggle placeholders", "Toggle placeholders", 12, 20, 1020, 1023);
